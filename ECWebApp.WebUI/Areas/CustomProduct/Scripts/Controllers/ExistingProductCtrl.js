app.controller('ExistingProductCtrl', function ($scope, $rootScope, $state, $stateParams, $http, $animate, $filter, $mdToast, GarmentService, MathService) {
    ...
    //$scope.CustomProductID = $stateParams.CustomProductID;
    ...
    $scope.specification = {
        ...
        'TextureID': null,
        'ProductCode': null,
        //'CustomProductID': $stateParams.CustomProductID,
        'Accessories': []
    };
    $scope.toastPosition = {
        bottom: true,
    ...
    $http.get('/CustomProduct/Custom/GetCustomProduct/' + $scope.ProductID).
      success(function (data, status, headers, config) {
        ...
        $scope.specification.ProductCode = data.ProductCode;
        //$scope.specification.CustomProductID = data.CustomProductID;
        GetTemplate();
        GetTexture();
        GetAccessories();
      }).
    ...
    //Get Textures
    function GetTexture() {
        $http.get('/CustomProduct/Custom/GetTextures/' + $scope.specification.TextureID).
        success(function (data, status, headers, config) {
    ...
    $scope.UpdateImage = function () {
        ...
        if ($scope.SelectedTexture != "//:0" && $scope.specification.TextureId != null) {
